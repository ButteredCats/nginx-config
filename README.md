...
It's been made public in the name of openness, as I apply many header changes (typically security or cache related) and also ocassionaly do rewrites with `sub_filter`.
